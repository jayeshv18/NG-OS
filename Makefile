...
build/kernel.bin: build/boot.o build/interrupt.o build/kernel.o build/idt.o build/keyboard.o build/timer.o build/vga.o build/gdt.o build/memory.o build/pmm.o build/paging.o build/heap.o build/pit.o build/task.o build/isr.o build/shell.o
	$(LD) $(LDFLAGS) $^ -o $@
